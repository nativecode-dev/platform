namespace NativeCode.Node.Media.Data.Migrations
{
    using System;
    ...
    public partial class Initial : Migration
    {
        ...
        {
            migrationBuilder.DropForeignKey("FK_Episodes_ReleaseInfo_ReleaseInfoId", "Episodes");

            migrationBuilder.DropForeignKey("FK_Series_ReleaseInfo_ReleaseInfoId", "Series");

            migrationBuilder.DropForeignKey("FK_Episodes_Seasons_SeasonId", "Episodes");

            migrationBuilder.DropTable("Image");

            migrationBuilder.DropTable("MediaProperty");

            migrationBuilder.DropTable("MetadataSource");

            migrationBuilder.DropTable("MountPathFile");

            migrationBuilder.DropTable("PlexServerInfo");

            migrationBuilder.DropTable("Tag");

            migrationBuilder.DropTable("SourceEpisodes");

            migrationBuilder.DropTable("SourceMovies");

            migrationBuilder.DropTable("MountPath");

            migrationBuilder.DropTable("PlexSources");

            migrationBuilder.DropTable("Movies");

            migrationBuilder.DropTable("Mounts");

            migrationBuilder.DropTable("MovieCollections");

            migrationBuilder.DropTable("Credentials");

            migrationBuilder.DropTable("ReleaseInfo");
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
                ...
                constraints: table =>
                    {
                        ...
                        table.ForeignKey(
                            "FK_Mounts_Credentials_CredentialId",
                            x => x.CredentialId,
                            "Credentials",
                            "Id",
                ...
                constraints: table =>
                    {
                        ...
                        table.ForeignKey(
                            ...
                            "Id",
                            onDelete: ReferentialAction.Restrict);
                        table.ForeignKey("FK_Image_Movies_MovieId", x => x.MovieId, "Movies", "Id", onDelete: ReferentialAction.Restrict);
                        table.ForeignKey("FK_Image_Series_SeriesId", x => x.SeriesId, "Series", "Id", onDelete: ReferentialAction.Restrict);
                    });
                ...
                constraints: table =>
                    {
                        ...
                        table.ForeignKey(
                            ...
                            "Id",
                            onDelete: ReferentialAction.Restrict);
                        table.ForeignKey("FK_Tag_Movies_MovieId", x => x.MovieId, "Movies", "Id", onDelete: ReferentialAction.Restrict);
                        table.ForeignKey("FK_Tag_Seasons_SeasonId", x => x.SeasonId, "Seasons", "Id", onDelete: ReferentialAction.Restrict);
                        table.ForeignKey("FK_Tag_Series_SeriesId", x => x.SeriesId, "Series", "Id", onDelete: ReferentialAction.Restrict);
                    });
            ...
            migrationBuilder.InsertData(
                "Mounts",
                new[] { "Id", "CredentialId", "DateCreated", "DateModified", "Host", "Name", "Type", "UserCreated", "UserModified" },
                new object[]
                    {
                        ...
                        "nas01.in.nativecode.com", "NAS01", 0, null, null,
                    });
                ...
                new object[]
                    {
                        ...
                        new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null,
                        "qnap.in.nativecode.com", "QNAP", 0, null, null,
                    });
                ...
                new object[]
                    {
                        ...
                        new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null,
                        "storage.in.nativecode.com", "STORAGE", 0, null, null,
                    });
                    ...
                    {
                        {
                            ...
                            null, new Guid("dfb9a8fb-320a-4d09-a70f-68184cd10723"), "/", null, null,
                        },
                        {
                            new Guid("826a7e0a-7b2b-4fa2-b10f-f2b94cd4783e"),
                            new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            null, new Guid("dfb9a8fb-320a-4d09-a70f-68184cd10723"), "/Movies", null, null,
                        },
                        {
                            new Guid("23f44e25-37f2-4e37-8a99-4584c390ef46"),
                            new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            null, new Guid("cd7cebdb-bbb5-4133-a7c4-fa3c700d110c"), "/", null, null,
                        },
                        {
                            new Guid("772ef0c4-decc-4977-8c50-21851398cf1f"),
                            new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            null, new Guid("cd7cebdb-bbb5-4133-a7c4-fa3c700d110c"), "/Media/Other", null, null,
                        },
                        {
                            new Guid("16f76922-a237-46b6-8f58-351c19353da1"),
                            new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            null, new Guid("4db231d2-a895-4128-a1a6-295c0fcfed91"), "/", null, null,
                        },
                        {
                            new Guid("742c9390-2b9c-4c18-a150-08fc18166263"),
                            new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            null, new Guid("4db231d2-a895-4128-a1a6-295c0fcfed91"), "/Media/Shows", null, null,
                        },
                    });

            migrationBuilder.CreateIndex("IX_Episodes_ReleaseInfoId", "Episodes", "ReleaseInfoId");

            migrationBuilder.CreateIndex("IX_Episodes_SeasonId", "Episodes", "SeasonId");

            migrationBuilder.CreateIndex("IX_Image_EpisodeId", "Image", "EpisodeId");

            migrationBuilder.CreateIndex("IX_Image_MovieCollectionId", "Image", "MovieCollectionId");

            migrationBuilder.CreateIndex("IX_Image_MovieId", "Image", "MovieId");

            migrationBuilder.CreateIndex("IX_Image_SeasonId", "Image", "SeasonId");

            migrationBuilder.CreateIndex("IX_Image_SeriesId", "Image", "SeriesId");

            migrationBuilder.CreateIndex("IX_MediaProperty_EpisodeId", "MediaProperty", "EpisodeId");

            migrationBuilder.CreateIndex("IX_MediaProperty_MovieCollectionId", "MediaProperty", "MovieCollectionId");

            migrationBuilder.CreateIndex("IX_MediaProperty_MovieId", "MediaProperty", "MovieId");

            migrationBuilder.CreateIndex("IX_MediaProperty_SeasonId", "MediaProperty", "SeasonId");

            migrationBuilder.CreateIndex("IX_MediaProperty_SeriesId", "MediaProperty", "SeriesId");

            migrationBuilder.CreateIndex("IX_MetadataSource_EpisodeId", "MetadataSource", "EpisodeId");

            migrationBuilder.CreateIndex("IX_MetadataSource_MovieId", "MetadataSource", "MovieId");

            migrationBuilder.CreateIndex("IX_MountPath_MountId", "MountPath", "MountId");

            migrationBuilder.CreateIndex("IX_MountPathFile_MediaSourceEpisodeId", "MountPathFile", "MediaSourceEpisodeId");

            migrationBuilder.CreateIndex("IX_MountPathFile_MediaSourceMovieId", "MountPathFile", "MediaSourceMovieId");

            migrationBuilder.CreateIndex("IX_MountPathFile_MountPathId", "MountPathFile", "MountPathId");

            migrationBuilder.CreateIndex("IX_Mounts_CredentialId", "Mounts", "CredentialId");

            migrationBuilder.CreateIndex("IX_Movies_MovieCollectionId", "Movies", "MovieCollectionId");

            migrationBuilder.CreateIndex("IX_Movies_ReleaseInfoId", "Movies", "ReleaseInfoId");

            migrationBuilder.CreateIndex("IX_PlexServerInfo_PlexLibrarySourceId", "PlexServerInfo", "PlexLibrarySourceId");

            migrationBuilder.CreateIndex("IX_Seasons_SeriesId", "Seasons", "SeriesId");

            migrationBuilder.CreateIndex("IX_Series_ReleaseInfoId", "Series", "ReleaseInfoId");

            migrationBuilder.CreateIndex("IX_SourceEpisodes_EpisodeId", "SourceEpisodes", "EpisodeId");

            migrationBuilder.CreateIndex("IX_SourceMovies_MovieId", "SourceMovies", "MovieId");

            migrationBuilder.CreateIndex("IX_Tag_EpisodeId", "Tag", "EpisodeId");

            migrationBuilder.CreateIndex("IX_Tag_MovieCollectionId", "Tag", "MovieCollectionId");

            migrationBuilder.CreateIndex("IX_Tag_MovieId", "Tag", "MovieId");

            migrationBuilder.CreateIndex("IX_Tag_SeasonId", "Tag", "SeasonId");

            migrationBuilder.CreateIndex("IX_Tag_SeriesId", "Tag", "SeriesId");
